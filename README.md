# Ranked-choice-Voting-Selection
*This is one of the CS50 projects that I did* 

This program can produce the Condorcet winner of an election if one exists

This program is meant for practice in pset3 of CS50x. One of the course from Harvard University.
...
![image](https://user-images.githubusercontent.com/81196027/188290927-6d7317a3-e22d-4179-9e6a-9b4de516fcc1.png)

A plurality vote would here declare a tie between Alice and Bob, since each has two votes. But is that the right outcome?

There’s another kind of voting system known as a ranked-choice voting system. In a ranked-choice system, voters can vote for more than one candidate. Instead of just voting for their top choice, they can rank the candidates in order of preference. The resulting ballots might therefore look like the below.

![image](https://user-images.githubusercontent.com/81196027/188290935-0e8708be-6d98-4479-a011-ae3b966fd4f6.png)
...
![image](https://user-images.githubusercontent.com/81196027/188290956-3d860452-902e-4990-9eea-e2b6eae5e7c0.png)
...
![image](https://user-images.githubusercontent.com/81196027/188290969-b5aee54c-85c3-48a6-8952-d0c1ee520040.png)
...
![image](https://user-images.githubusercontent.com/81196027/188290987-15a627d5-53e0-468c-bcef-f886eb9b36fd.png)
